...
// RUN: llvm-spirv %t.bc --spirv-ext=+SPV_INTEL_media_block_io -spirv-text -o - | FileCheck %s --check-prefix=CHECK-SPIRV
// RUN: llvm-spirv %t.bc --spirv-ext=+SPV_INTEL_media_block_io -o %t.spv
// RUN: spirv-val %t.spv
// RUN: llvm-spirv -r --spirv-ext=+SPV_INTEL_media_block_io %t.spv -o %t.rev.bc
